...
public class LatestEntity {
    ...
    private int id_latest;
    @SerializedName("id")
    private int id;
    @SerializedName("image")
    private String image;
    @SerializedName("badge_trending")
    private boolean badge_trending;
    @SerializedName("img_reaction")
    private String img_reaction;
    ...
    public int getId_latest() {
        return id_latest;
    }

    public void setId_latest(int id_latest) {
        this.id_latest = id_latest;
    }
    ...
    public boolean isBadge_trending() {
        return badge_trending;
    }

    public void setBadge_trending(boolean badge_trending) {
        this.badge_trending = badge_trending;
    }

    public String getImg_reaction() {
        return img_reaction;
    }

    public void setImg_reaction(String img_reaction) {
